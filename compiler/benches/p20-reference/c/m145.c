...
static long pick145_0_0(long a, long b) { return a > b ? a : b; }
static long pick145_0_1(long a, long b) { return a > b ? a : b; }
static long pick145_0_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    int flag;
...
static long pick145_1_0(long a, long b) { return a > b ? a : b; }
static long pick145_1_1(long a, long b) { return a > b ? a : b; }
static long pick145_1_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    int flag;
...
static long pick145_2_0(long a, long b) { return a > b ? a : b; }
static long pick145_2_1(long a, long b) { return a > b ? a : b; }
static long pick145_2_2(long a, long b) { return a > b ? a : b; }
long f145(long x) {
    long acc = x;
    acc += f037(x + 1);
    ...
    acc += accum145_0(6);
    acc += guard145_0(acc);
    acc += pick145_0_0(acc, acc + 1);
    acc += pick145_0_1(acc, acc + 4);
    acc += pick145_0_2(acc, acc + 3);
    ...
    acc += accum145_1(6);
    acc += guard145_1(acc);
    acc += pick145_1_0(acc, acc + 3);
    acc += pick145_1_1(acc, acc + 9);
    acc += pick145_1_2(acc, acc + 7);
    ...
    acc += accum145_2(8);
    acc += guard145_2(acc);
    acc += pick145_2_0(acc, acc + 6);
    acc += pick145_2_1(acc, acc + 4);
    acc += pick145_2_2(acc, acc + 8);
    return clampi(acc);
}

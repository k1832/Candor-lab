...
static long pick192_0_0(long a, long b) { return a > b ? a : b; }
static long pick192_0_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick192_1_0(long a, long b) { return a > b ? a : b; }
static long pick192_1_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    int flag;
...
static long pick192_2_0(long a, long b) { return a > b ? a : b; }
static long pick192_2_1(long a, long b) { return a > b ? a : b; }
static long pick192_2_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick192_3_0(long a, long b) { return a > b ? a : b; }
static long pick192_3_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick192_4_0(long a, long b) { return a > b ? a : b; }
long f192(long x) {
    long acc = x;
    acc += f000(x + 1);
    acc += f040(x + 2);
    ...
    acc += accum192_0(7);
    acc += guard192_0(acc);
    acc += pick192_0_0(acc, acc + 3);
    acc += pick192_0_1(acc, acc + 9);
    ...
    acc += accum192_1(7);
    acc += guard192_1(acc);
    acc += pick192_1_0(acc, acc + 3);
    acc += pick192_1_1(acc, acc + 5);
    ...
    acc += accum192_2(5);
    acc += guard192_2(acc);
    acc += pick192_2_0(acc, acc + 8);
    acc += pick192_2_1(acc, acc + 3);
    acc += pick192_2_2(acc, acc + 8);
    ...
    acc += accum192_3(3);
    acc += guard192_3(acc);
    acc += pick192_3_0(acc, acc + 9);
    acc += pick192_3_1(acc, acc + 2);

...
static long pick105_0_0(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick105_1_0(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    int flag;
...
static long pick105_2_0(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick105_3_0(long a, long b) { return a > b ? a : b; }
static long pick105_3_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick105_4_0(long a, long b) { return a > b ? a : b; }
static long pick105_4_1(long a, long b) { return a > b ? a : b; }
static long pick105_4_2(long a, long b) { return a > b ? a : b; }
long f105(long x) {
    long acc = x;
    acc += f040(x + 1);
    acc += f053(x + 2);
    ...
    acc += accum105_3(6);
    acc += guard105_3(acc);
    acc += pick105_3_0(acc, acc + 1);
    acc += pick105_3_1(acc, acc + 5);
    ...
    acc += accum105_4(4);
    acc += guard105_4(acc);
    acc += pick105_4_0(acc, acc + 7);
    acc += pick105_4_1(acc, acc + 6);
    acc += pick105_4_2(acc, acc + 2);
    return clampi(acc);
}

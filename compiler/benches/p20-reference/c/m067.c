...
static long pick67_0_0(long a, long b) { return a > b ? a : b; }
static long pick67_0_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick67_1_0(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick67_2_0(long a, long b) { return a > b ? a : b; }
static long pick67_2_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick67_3_0(long a, long b) { return a > b ? a : b; }
static long pick67_3_1(long a, long b) { return a > b ? a : b; }
static long pick67_3_2(long a, long b) { return a > b ? a : b; }
long f067(long x) {
    long acc = x;
    acc += f008(x + 1);
    acc += f014(x + 2);
    ...
    acc += accum67_0(8);
    acc += guard67_0(acc);
    acc += pick67_0_0(acc, acc + 8);
    acc += pick67_0_1(acc, acc + 6);
    S67_1 s1 = mk67_1(acc);
    bump67_1(&s1, 9);
    acc += probe67_1(&s1);
    acc += read67_1(&s1);
    ...
    acc += accum67_2(3);
    acc += guard67_2(acc);
    acc += pick67_2_0(acc, acc + 7);
    acc += pick67_2_1(acc, acc + 7);
    S67_3 s3 = mk67_3(acc);
    bump67_3(&s3, 1);
    acc += probe67_3(&s3);
    acc += read67_3(&s3);
    ...
    acc += accum67_3(5);
    acc += guard67_3(acc);
    acc += pick67_3_0(acc, acc + 4);
    acc += pick67_3_1(acc, acc + 2);
    acc += pick67_3_2(acc, acc + 4);
    return clampi(acc);
}

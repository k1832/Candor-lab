...
static long pick47_0_0(long a, long b) { return a > b ? a : b; }
static long pick47_0_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick47_1_0(long a, long b) { return a > b ? a : b; }
static long pick47_1_1(long a, long b) { return a > b ? a : b; }
static long pick47_1_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    int flag;
...
static long pick47_2_0(long a, long b) { return a > b ? a : b; }
static long pick47_2_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick47_3_0(long a, long b) { return a > b ? a : b; }
static long pick47_3_1(long a, long b) { return a > b ? a : b; }
static long pick47_3_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    int flag;
...
static long pick47_4_0(long a, long b) { return a > b ? a : b; }
static long pick47_4_1(long a, long b) { return a > b ? a : b; }
static long pick47_4_2(long a, long b) { return a > b ? a : b; }
long f047(long x) {
    long acc = x;
    acc += f010(x + 1);
    acc += f013(x + 2);
    ...
    acc += accum47_0(9);
    acc += guard47_0(acc);
    acc += pick47_0_0(acc, acc + 9);
    acc += pick47_0_1(acc, acc + 2);
    S47_1 s1 = mk47_1(acc);
    bump47_1(&s1, 9);
    acc += probe47_1(&s1);
    acc += read47_1(&s1);
    ...
    acc += accum47_1(9);
    acc += guard47_1(acc);
    acc += pick47_1_0(acc, acc + 9);
    acc += pick47_1_1(acc, acc + 9);
    acc += pick47_1_2(acc, acc + 3);
    S47_2 s2 = mk47_2(acc);
    bump47_2(&s2, 1);
    acc += probe47_2(&s2);
    acc += read47_2(&s2);
    ...
    acc += accum47_2(8);
    acc += guard47_2(acc);
    acc += pick47_2_0(acc, acc + 5);
    acc += pick47_2_1(acc, acc + 7);
    S47_3 s3 = mk47_3(acc);
    bump47_3(&s3, 5);
    acc += probe47_3(&s3);
    acc += read47_3(&s3);
    ...
    acc += accum47_3(4);
    acc += guard47_3(acc);
    acc += pick47_3_0(acc, acc + 7);
    acc += pick47_3_1(acc, acc + 2);
    acc += pick47_3_2(acc, acc + 2);
    S47_4 s4 = mk47_4(acc);
    bump47_4(&s4, 3);
    acc += probe47_4(&s4);
    acc += read47_4(&s4);
    ...
    acc += accum47_4(3);
    acc += guard47_4(acc);
    acc += pick47_4_0(acc, acc + 2);
    acc += pick47_4_1(acc, acc + 2);
    acc += pick47_4_2(acc, acc + 3);
    return clampi(acc);
}

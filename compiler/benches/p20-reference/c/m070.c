...
static long pick70_0_0(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    int flag;
...
static long pick70_1_0(long a, long b) { return a > b ? a : b; }
static long pick70_1_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick70_2_0(long a, long b) { return a > b ? a : b; }
static long pick70_2_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick70_3_0(long a, long b) { return a > b ? a : b; }
long f070(long x) {
    long acc = x;
    acc += f012(x + 1);
    S70_0 s0 = mk70_0(acc);
    ...
    acc += accum70_1(5);
    acc += guard70_1(acc);
    acc += pick70_1_0(acc, acc + 6);
    acc += pick70_1_1(acc, acc + 6);
    S70_2 s2 = mk70_2(acc);
    bump70_2(&s2, 8);
    acc += probe70_2(&s2);
    acc += read70_2(&s2);
    ...
    acc += accum70_2(8);
    acc += guard70_2(acc);
    acc += pick70_2_0(acc, acc + 7);
    acc += pick70_2_1(acc, acc + 4);
    S70_3 s3 = mk70_3(acc);
    bump70_3(&s3, 4);
    acc += probe70_3(&s3);
    acc += read70_3(&s3);

...
static long pick29_0_0(long a, long b) { return a > b ? a : b; }
static long pick29_0_1(long a, long b) { return a > b ? a : b; }
static long pick29_0_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick29_1_0(long a, long b) { return a > b ? a : b; }
static long pick29_1_1(long a, long b) { return a > b ? a : b; }
static long pick29_1_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick29_2_0(long a, long b) { return a > b ? a : b; }
long f029(long x) {
    long acc = x;
    acc += f006(x + 1);
    S29_0 s0 = mk29_0(acc);
    ...
    acc += accum29_0(9);
    acc += guard29_0(acc);
    acc += pick29_0_0(acc, acc + 6);
    acc += pick29_0_1(acc, acc + 8);
    acc += pick29_0_2(acc, acc + 9);
    S29_1 s1 = mk29_1(acc);
    bump29_1(&s1, 3);
    acc += probe29_1(&s1);
    acc += read29_1(&s1);
    ...
    acc += accum29_1(3);
    acc += guard29_1(acc);
    acc += pick29_1_0(acc, acc + 6);
    acc += pick29_1_1(acc, acc + 9);
    acc += pick29_1_2(acc, acc + 8);
    S29_2 s2 = mk29_2(acc);
    bump29_2(&s2, 6);
    acc += probe29_2(&s2);
    acc += read29_2(&s2);

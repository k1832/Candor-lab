...
static long pick85_0_0(long a, long b) { return a > b ? a : b; }
static long pick85_0_1(long a, long b) { return a > b ? a : b; }
static long pick85_0_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick85_1_0(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick85_2_0(long a, long b) { return a > b ? a : b; }
static long pick85_2_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    int flag;
...
static long pick85_3_0(long a, long b) { return a > b ? a : b; }
static long pick85_3_1(long a, long b) { return a > b ? a : b; }
static long pick85_3_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick85_4_0(long a, long b) { return a > b ? a : b; }
static long pick85_4_1(long a, long b) { return a > b ? a : b; }
long f085(long x) {
    long acc = x;
    acc += f014(x + 1);
    acc += f031(x + 2);
    ...
    acc += accum85_0(5);
    acc += guard85_0(acc);
    acc += pick85_0_0(acc, acc + 5);
    acc += pick85_0_1(acc, acc + 9);
    acc += pick85_0_2(acc, acc + 2);
    S85_1 s1 = mk85_1(acc);
    bump85_1(&s1, 1);
    acc += probe85_1(&s1);
    acc += read85_1(&s1);
    ...
    acc += accum85_2(4);
    acc += guard85_2(acc);
    acc += pick85_2_0(acc, acc + 8);
    acc += pick85_2_1(acc, acc + 6);
    S85_3 s3 = mk85_3(acc);
    bump85_3(&s3, 5);
    acc += probe85_3(&s3);
    acc += read85_3(&s3);
    ...
    acc += accum85_3(6);
    acc += guard85_3(acc);
    acc += pick85_3_0(acc, acc + 6);
    acc += pick85_3_1(acc, acc + 8);
    acc += pick85_3_2(acc, acc + 6);
    S85_4 s4 = mk85_4(acc);
    bump85_4(&s4, 1);
    acc += probe85_4(&s4);
    acc += read85_4(&s4);
    ...
    acc += accum85_4(5);
    acc += guard85_4(acc);
    acc += pick85_4_0(acc, acc + 1);
    acc += pick85_4_1(acc, acc + 2);
    return clampi(acc);
}

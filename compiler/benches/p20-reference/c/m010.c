...
static long pick10_0_0(long a, long b) { return a > b ? a : b; }
static long pick10_0_1(long a, long b) { return a > b ? a : b; }
static long pick10_0_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick10_1_0(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    int flag;
...
static long pick10_2_0(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    int flag;
...
static long pick10_3_0(long a, long b) { return a > b ? a : b; }
long f010(long x) {
    long acc = x;
    acc += f002(x + 1);
    acc += f003(x + 2);
    ...
    acc += accum10_0(7);
    acc += guard10_0(acc);
    acc += pick10_0_0(acc, acc + 5);
    acc += pick10_0_1(acc, acc + 5);
    acc += pick10_0_2(acc, acc + 8);
    S10_1 s1 = mk10_1(acc);
    bump10_1(&s1, 9);
    acc += probe10_1(&s1);
    acc += read10_1(&s1);

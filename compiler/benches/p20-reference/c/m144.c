...
static long pick144_0_0(long a, long b) { return a > b ? a : b; }
static long pick144_0_1(long a, long b) { return a > b ? a : b; }
static long pick144_0_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick144_1_0(long a, long b) { return a > b ? a : b; }
static long pick144_1_1(long a, long b) { return a > b ? a : b; }
static long pick144_1_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick144_2_0(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick144_3_0(long a, long b) { return a > b ? a : b; }
static long pick144_3_1(long a, long b) { return a > b ? a : b; }
static long pick144_3_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick144_4_0(long a, long b) { return a > b ? a : b; }
static long pick144_4_1(long a, long b) { return a > b ? a : b; }
long f144(long x) {
    long acc = x;
    acc += f036(x + 1);
    acc += f052(x + 2);
    ...
    acc += accum144_0(7);
    acc += guard144_0(acc);
    acc += pick144_0_0(acc, acc + 2);
    acc += pick144_0_1(acc, acc + 2);
    acc += pick144_0_2(acc, acc + 8);
    ...
    acc += accum144_1(3);
    acc += guard144_1(acc);
    acc += pick144_1_0(acc, acc + 8);
    acc += pick144_1_1(acc, acc + 7);
    acc += pick144_1_2(acc, acc + 8);
    ...
    acc += accum144_3(7);
    acc += guard144_3(acc);
    acc += pick144_3_0(acc, acc + 4);
    acc += pick144_3_1(acc, acc + 1);
    acc += pick144_3_2(acc, acc + 9);
    ...
    acc += accum144_4(3);
    acc += guard144_4(acc);
    acc += pick144_4_0(acc, acc + 7);
    acc += pick144_4_1(acc, acc + 4);
    return clampi(acc);
}

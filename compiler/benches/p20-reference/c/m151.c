...
static long pick151_0_0(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick151_1_0(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    int flag;
...
static long pick151_2_0(long a, long b) { return a > b ? a : b; }
static long pick151_2_1(long a, long b) { return a > b ? a : b; }
static long pick151_2_2(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick151_3_0(long a, long b) { return a > b ? a : b; }
static long pick151_3_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick151_4_0(long a, long b) { return a > b ? a : b; }
static long pick151_4_1(long a, long b) { return a > b ? a : b; }
long f151(long x) {
    long acc = x;
    acc += f035(x + 1);
    ...
    acc += accum151_2(9);
    acc += guard151_2(acc);
    acc += pick151_2_0(acc, acc + 8);
    acc += pick151_2_1(acc, acc + 6);
    acc += pick151_2_2(acc, acc + 2);
    ...
    acc += accum151_3(5);
    acc += guard151_3(acc);
    acc += pick151_3_0(acc, acc + 3);
    acc += pick151_3_1(acc, acc + 4);
    ...
    acc += accum151_4(9);
    acc += guard151_4(acc);
    acc += pick151_4_0(acc, acc + 5);
    acc += pick151_4_1(acc, acc + 5);
    return clampi(acc);
}

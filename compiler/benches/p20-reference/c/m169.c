...
static long pick169_0_0(long a, long b) { return a > b ? a : b; }
static long pick169_0_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    int flag;
...
static long pick169_1_0(long a, long b) { return a > b ? a : b; }
static long pick169_1_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick169_2_0(long a, long b) { return a > b ? a : b; }
static long pick169_2_1(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick169_3_0(long a, long b) { return a > b ? a : b; }
typedef struct {
    long a;
    long n0;
    long n1;
...
static long pick169_4_0(long a, long b) { return a > b ? a : b; }
static long pick169_4_1(long a, long b) { return a > b ? a : b; }
long f169(long x) {
    long acc = x;
    acc += f058(x + 1);
    acc += f148(x + 2);
    ...
    acc += accum169_0(3);
    acc += guard169_0(acc);
    acc += pick169_0_0(acc, acc + 1);
    acc += pick169_0_1(acc, acc + 8);
    ...
    acc += accum169_1(9);
    acc += guard169_1(acc);
    acc += pick169_1_0(acc, acc + 1);
    acc += pick169_1_1(acc, acc + 1);
    ...
    acc += accum169_2(7);
    acc += guard169_2(acc);
    acc += pick169_2_0(acc, acc + 5);
    acc += pick169_2_1(acc, acc + 5);
    ...
    acc += accum169_4(7);
    acc += guard169_4(acc);
    acc += pick169_4_0(acc, acc + 2);
    acc += pick169_4_1(acc, acc + 7);
    return clampi(acc);
}

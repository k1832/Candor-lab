...
#[test]
fn run_real_11_1_allocator() {
    assert_eq!(run_real_ret("11_1_allocator.cnr"), 1234);
}
#[test]
fn run_real_11_2_scheduler() {
    assert_eq!(run_real_ret("11_2_scheduler.cnr"), 42);
}
#[test]
fn run_real_11_3_mmio() {
    assert_eq!(run_real_ret("11_3_mmio.cnr"), 42);
}
#[test]
fn run_real_11_4_parser() {
    assert_eq!(run_real_ret("11_4_parser.cnr"), 17);
}
#[test]
fn run_real_11_5_arena() {
    assert_eq!(run_real_ret("11_5_arena.cnr"), 5);
}

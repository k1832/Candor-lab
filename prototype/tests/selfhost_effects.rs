...
//!
//! Harness shape reuses slice 5 (`selfhost_loans.rs`): embed the fixture source
//! as a `[N]u8` literal, lex + parse + analyze + dump via the concatenated `.cnr`
//! program on a 256 MiB thread, compare to the filtered+sorted oracle rendering.
